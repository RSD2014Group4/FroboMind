...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rsd_camera_functions-msg:<Num> is deprecated: use rsd_camera_functions-msg:Num instead.")))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rsd_camera_functions-msg:distance-val is deprecated.  Use rsd_camera_functions-msg:distance instead.")
  (distance m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rsd_camera_functions-msg:angle-val is deprecated.  Use rsd_camera_functions-msg:angle instead.")
  (angle m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Num>)))
  ...
  (cl:format cl:nil "int64 distance~%~%float32 angle~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Num)))
  "Returns full string definition for message of type 'Num"
  (cl:format cl:nil "int64 distance~%~%float32 angle~%~%~%"))
